          ...
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <div class="card-body">
                ...
                <form action="{{ url('register/proses') }}" role="form text-left">
                    @csrf
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="nik" aria-label="nik" aria-describedby="email-addon" name="nik">
                  </div>
                  <div class="mb-3">
                    <input type="email" class="form-control" placeholder="Email" aria-label="Email" aria-describedby="email-addon" name="email">
                  </div>
                  <div class="mb-3">
                    <input type="number" class="form-control" placeholder="telp" aria-label="telp" aria-describedby="email-addon" name="telp">
                  </div>
                  <div class="mb-3">

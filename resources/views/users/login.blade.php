              ...
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  ...
                  <p class="mb-0">Enter your email and password to sign in</p>
                    ...
                    <div class="card-body">
                    <form role="form" action="{{ url('login/proses') }}" method="POST">
                        @csrf
                        <label>Email</label>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0" id='btn-submit'>Sign in</button>
                        </div>
                    </form>
                </div>
